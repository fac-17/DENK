...
INSERT INTO tarot_cards (tarot_heading, tarot_description, tarot_image) VALUES
  ...
  ('The Visionary',
    'The Visionary hasn\'t just seen the light - The Visionary is the light - or so The Visionary believes.
    And it is The Visionary who believes hard enough can infect others with their belief.
    Afterall, who among us is not drawn to the light; the warmth of confidence; the brightness of certainty?
    The Visionary has a solution, but remember, Visionaries have different problems to the rest of us - that\'s why they see things we don\'t.
    The Visionary shines brightly, blinding those who look up to them - but they cast long shadows too. What is illuminated, and what is concealed by the dark?',
    '<svg width="200" viewBox="0 0 220 420" strokeWidth="3" fill="none" stroke="black"><rect x="10" y="20" width="200" height="400"></rect></svg>'),

  ('The Consumer',
    'The Consumer may represent the protagonist of the narrative, but also stands for the urge to transcend the status quo, to act without forethought. The Consumer is innocent, and occasionally outright foolish. The Consumer is - as yet - unbruised by the world into which they enthusiastically set off. While there can be bravery in The Consumer\'s innocence: a willingless to changeor to be changed, bad things happen to innocents abroad...and they may be poor company when the chips are down.',
    '<svg width="200" viewBox="0 0 220 420" strokeWidth="3" fill="none" stroke="black"><rect x="10" y="20" width="200" height="400"></rect></svg>'),

  ('Capital',
    'Capital is production and productivity, the potential for action and the urge to act. Capital is resources - human, natural and otherwise. Capital is row, unformed and unorganised: useless on its own, nothing can be done without it. Capital serves no master but itself, just as those who serve only Capital serve only themselves. Capital is the cake and the knife that cuts it. Will you grab for a slice or settle for the crumbs?',
    '<svg width="200" viewBox="0 0 220 420" strokeWidth="3" fill="none" stroke="black"><rect x="10" y="20" width="200" height="400"></rect></svg>'),

  ('The Meme',
    'The Meme is a bright nightmare or a dark daydream dragged out of the far corners of the culture, a joke that goes bump in the night. The Meme is the unspeakable spoken as cliché, the stereotype raised to the status of art. The meme is all that\'s wrong with that thing you love, and everything that\'s good about that thing you hate. The Meme like fiction, is the little lie that sometimes tells a larger truth.
    The Meme can question Authority or speak on Authority\'s behalf. The Meme is clever but cruel: it\'s all fun and games until it\'s your face on 4chan.',
    '<svg width="200" viewBox="0 0 220 420" strokeWidth="3" fill="none" stroke="black"><rect x="10" y="20" width="200" height="400"></rect></svg>')
